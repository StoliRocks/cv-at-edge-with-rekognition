...
This is a sample template for rekognition-state-machine - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name rekognition-state-machine \
...
```bash
sam logs -n HelloWorldFunction --stack-name rekognition-state-machine --tail
```
...
```bash
aws cloudformation delete-stack --stack-name rekognition-state-machine
```
